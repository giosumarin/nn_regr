...
class NN:
    ...
    def updateMomentum(self, X, t):
        ...
        for [indexLow,indexHigh] in indexes_minibatchs:
            ...
            y = outputs[-1]
            #print(smooth_max(y, t[indexLow:indexHigh], True))
            #print("-"*20)
            #print(y-t[indexLow:indexHigh])
            #print("+"*20)
            #print(np.abs(y-t[indexLow:indexHigh]))
            #print("||"*20)
            deltas = [self.act_fun[-1](y, True) * smooth_max(y, t[indexLow:indexHigh], True)] #* (y - t[indexLow:indexHigh])
    ...
    def train(self, stop_function, num_epochs, total_example=None):
        ...
        while self.stop_fun(stop_function, num_epochs, last_loss, total_example):
            ...
            if self.epoch % 10 == 0 and self.disableLog==False:
