    ...
    for p in range(10,96,10):
        ...
        for perc in percList:
            ...
            with open("res_nn1_pred_pr.txt", "a+") as mf:
                mf.write("NN_1 file{} perc{} {}ms".format(i,perc,t1*1000))
            with open("res_nn2.txt_pred_pr", "a+") as mf:
                mf.write("NN_2 file{} perc{} {}ms".format(i,perc,t2*1000))
            with open("res_nn3.txt_pred_pr", "a+") as mf:
                mf.write("NN_3 file{} perc{} {}ms".format(i,perc,t3*1000))
